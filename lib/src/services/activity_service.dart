...
class ActivityService {
  ...
  Future<Map<String, dynamic>> getStreamData({int? sessionKey, String? sessionId, int? userId}) async {
    final params = <String, dynamic>{};
    if (sessionKey != null) params['session_key'] = sessionKey;
    if (sessionId != null) params['session_id'] = sessionId;
  ...
  Future<void> terminateSession({String? sessionId, int? sessionKey, String? message}) async {
    final params = <String, dynamic>{};
    if (sessionId != null) params['session_id'] = sessionId;
    if (sessionKey != null) params['session_key'] = sessionKey;
